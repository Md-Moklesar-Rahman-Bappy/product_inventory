                ...
                <div class="row gy-3 align-items-center">
                    <div class="col-12 col-lg-2 d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <small class="text-white opacity-75">{{ $brands->total() }} total</small>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        <form id="searchForm" method="GET" action="{{ route('brands.index') }}" class="d-none">
                            ...
                            <div class="d-flex flex-wrap justify-content-lg-end gap-2">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="{{ route('brands.export') }}">Export</a></li>
                                    </ul>
                                </div>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr @if($b->trashed()) class="bg-danger-subtle" @endif>
                            <td class="ps-4">
                                <span class="row-number">{{ ($brands->currentPage() - 1) * $brands->perPage() + $loop->iteration }}</span>
                            </td>
                            <td>
