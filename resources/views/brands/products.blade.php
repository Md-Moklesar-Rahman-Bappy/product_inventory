            ...
            <div class="table-header-section">
                <div class="row gy-3 align-items-center">
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        <form id="searchForm" method="GET" action="{{ route('brands.products', $brand->id) }}" class="d-none">
                            ...
                            <div class="d-flex flex-wrap justify-content-lg-end gap-2">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="{{ route('products.export.brand', $brand->id) }}">Export</a></li>
                                    </ul>
                                </div>
                                <a href="{{ route('products.create', ['brand_id' => $brand->id]) }}" class="btn btn-sm btn-success">
