      ...
      <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center py-3 px-4">
        <div class="d-flex align-items-center gap-3">
          <h3 class="mb-0 fw-bold">
            <i class="fa fa-industry me-2"></i> Products in {{ $brand->brand_name }}
          </h3>
        ...
        <div class="d-flex flex-wrap gap-2 align-items-center">
          ...
          {{-- 🔍 Search Bar --}}
          <form method="GET" action="{{ route('brands.products', $brand->id) }}" class="d-flex" style="max-width: 400px;">
          ...
          @if(auth()->user()->permission <= 1)
            ...
            {{-- 📤 Export --}}
            <a href="{{ route('products.export.brand', $brand->id) }}" class="btn btn-outline-success">
              📤 Export for {{ $brand->brand_name }}
            </a>
          @endif
