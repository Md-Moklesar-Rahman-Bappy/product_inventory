            ...
            <div class="table-header-section">
                <div class="row gy-3 align-items-center">
                    <div class="col-12 col-lg-3 d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="mb-0 fw-bold text-white">Products in {{ $brand->brand_name }}</h5>
                    ...
                    <div class="col-12 col-lg-5 text-lg-end">
                        <a href="{{ route('brands.index') }}" class="btn btn-sm btn-light me-2">
                            <i class="bi bi-arrow-left me-1"></i>Back
                        </a>
                        @if(auth()->user()->permission <= 1)
                            <div class="d-flex flex-wrap justify-content-lg-end gap-2 d-inline">
                                <a href="{{ route('products.create', ['brand_id' => $brand->id]) }}" class="btn btn-sm btn-add">
                                    <i class="bi bi-plus-lg me-1"></i>Add
                                </a>
                                <a href="{{ route('products.export.brand', $brand->id) }}" class="btn btn-sm btn-light">
