...
<head>
  ...
  @endphp
  <title>{{ $appName }} - Password Recovery via Email</title>
  <meta charset="UTF-8">
...
<body>
  <div class="login-wrapper">
    <div class="login-card">
      <i class="bi bi-envelope-at-fill login-icon" style="font-size: 4rem; color: #4f46e5;"></i>
      <form method="POST" action="{{ route('password.forgot.email.send') }}" novalidate>
        @csrf
        <div class="login-title">Email Recovery</div>
        <p style="color: #64748b; font-size: 0.9rem; margin-bottom: 24px;">Enter the email address associated with your account.</p>
