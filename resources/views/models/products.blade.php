            ...
            <div class="card-header bg-white border-bottom py-3">
                <div class="row gy-3 align-items-center">
                    <div class="col-12 col-lg-3 d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="mb-0 fw-bold text-dark">Products in {{ $model->model_name }}</h5>
                    ...
                    <div class="col-12 col-lg-5 text-lg-end">
                        @if(auth()->user()->permission <= 1)
                            <div class="d-flex flex-wrap justify-content-lg-end gap-2">
                                <a href="{{ route('products.create', ['model_id' => $model->id]) }}" class="btn btn-sm btn-primary">
                                    <i class="bi bi-plus-lg me-1"></i>Add
                                </a>
                                <a href="{{ route('products.export.model', $model->id) }}" class="btn btn-sm btn-outline-success">
                                    <i class="bi bi-file-earmark-excel me-1"></i>Export
                                </a>
                            </div>
                        @endif
                        <a href="{{ route('models.index') }}" class="btn btn-sm btn-light mt-2 mt-lg-0">
