            ...
            <div class="table-header-section">
                <div class="row gy-3 align-items-center">
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        <form id="searchForm" method="GET" action="{{ route('models.products', $model->id) }}" class="d-none">
                    ...
                    <div class="col-12 col-lg-3 text-lg-end">
                        @if(auth()->user()->permission <= 1)
                            <div class="d-flex flex-wrap justify-content-lg-end gap-2">
                                <a href="{{ route('models.index') }}" class="btn btn-sm btn-light">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="{{ route('products.export.model', $model->id) }}">Export</a></li>
                                    </ul>
                                </div>
                                <a href="{{ route('products.create', ['model_id' => $model->id]) }}" class="btn btn-sm btn-success">
