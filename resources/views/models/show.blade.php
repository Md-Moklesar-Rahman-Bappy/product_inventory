        ...
        <div class="modern-table-card">
            <div class="table-header-section">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{ route('models.index') }}" class="btn btn-sm btn-outline-light">
            ...
            <div class="card-body p-4">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="detail-card">
                                ...
                                <span class="detail-value">
                                    <span class="category-badge">{{ $model->products_count ?? $model->products->count() }}</span>
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="d-flex justify-content-end gap-3 pt-3 border-top">
                    <a href="{{ route('models.index') }}" class="btn btn-outline-secondary px-4">
                        <i class="bi bi-arrow-left me-1"></i>Back
                    </a>
                    @if(auth()->user()->permission <= 1)
                        <a href="{{ route('models.edit', $model->id) }}" class="btn btn-edit px-4">
