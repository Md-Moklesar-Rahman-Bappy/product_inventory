    ...
    <div class="card-body bg-light" style="padding: 2rem;">
      <form action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
          ...
          <input type="text" name="category_name" id="category_name" class="form-control form-control-lg shadow-sm" placeholder="Enter category name..." value="{{ old('category_name') }}" required>
        </div>
