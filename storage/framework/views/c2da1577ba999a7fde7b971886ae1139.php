    ...
    <div class="col-lg-10 offset-lg-1">
        <div class="profile-upload-card">
            ...
            <div class="card-body p-4">
                ...
                <form action="<?php echo e(route('users.update', $user->id)); ?>" method="POST" enctype="multipart/form-data" id="userForm">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control form-input" 
                                        placeholder="Enter user name" value="<?php echo e(old('name', $user->name)); ?>" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label-custom">Email Address</label>
                                    <input type="email" name="email" class="form-control form-input" 
                                        placeholder="Enter email" value="<?php echo e(old('email', $user->email)); ?>" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="mobile" class="form-control form-input" 
                                        placeholder="Enter mobile number" value="<?php echo e(old('mobile', $user->mobile)); ?>">
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="permission" class="form-select form-input" required>
                                        ...
                                        <option value="0" <?php echo e(old('permission', $user->permission) == 0 ? 'selected' : ''); ?>>Super Admin</option>
                                        <?php endif; ?>
                                        <option value="1" <?php echo e(old('permission', $user->permission) == 1 ? 'selected' : ''); ?>>Admin</option>
                                        <option value="2" <?php echo e(old('permission', $user->permission) == 2 ? 'selected' : ''); ?>>User</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="designation" class="form-control form-input" 
                                        placeholder="Enter designation" value="<?php echo e(old('designation', $user->designation)); ?>">
                                </div>
                                <div class="col-md-6 mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="about" class="form-control form-input" rows="2" placeholder="Brief description about this user"><?php echo e(old('about', $user->about)); ?></textarea>
                            </div>
                            <div class="mb-3">
                                <label class="form-label-custom">Address</label>
                                <textarea name="address" class="form-control form-input" rows="2" placeholder="Enter address"><?php echo e(old('address', $user->address)); ?></textarea>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xammp\htdocs\bug-fixes v3\product_inventory\resources\views/users/edit.blade.php ENDPATH**/ ?>