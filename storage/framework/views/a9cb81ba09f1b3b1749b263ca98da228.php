...
<?php $__env->startSection('content'); ?>
    ...
    <form method="POST" action="<?php echo e(route('install.admin.store')); ?>">
        <?php echo csrf_field(); ?>

        <?php $__errorArgs = ['installation'];
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="text-center">
            <a href="<?php echo e(route('install.license')); ?>" class="btn btn-outline-secondary me-2">
...
<?php echo $__env->make('install.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xammp\htdocs\bug-fixes v3\product_inventory\resources\views\install\admin.blade.php ENDPATH**/ ?>