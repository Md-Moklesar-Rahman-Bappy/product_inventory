                ...
                <form action="<?php echo e(route('products.update', $product->id)); ?>" method="POST">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="product_name" class="form-control form-input"
                                value="<?php echo e(old('product_name', $product->product_name)); ?>" placeholder="Enter product name" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label-custom">Price (৳)</label>
                            <input type="number" name="price" class="form-control form-input"
                                value="<?php echo e(old('price', $product->price)); ?>" step="0.01" min="0" placeholder="0.00" required>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="serial_no" class="form-control form-input"
                                value="<?php echo e(old('serial_no', $product->serial_no)); ?>" placeholder="Enter serial number">
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="project_serial_no" class="form-control form-input"
                                value="<?php echo e(old('project_serial_no', $product->project_serial_no)); ?>" placeholder="Enter project serial number">
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="position" class="form-control form-input"
                                value="<?php echo e(old('position', $product->position)); ?>" placeholder="Enter location">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label-custom">User Description</label>
                            <textarea name="user_description" class="form-control form-input" rows="3"
                                placeholder="Enter description"><?php echo e(old('user_description', $product->user_description)); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="remarks" class="form-control form-input"
                                value="<?php echo e(old('remarks', $product->remarks)); ?>" placeholder="Enter remarks">
                        </div>
                    </div>
                    ...
                    <?php if($product->warranty_end): ?>
                        <div class="alert alert-info mb-4" style="border-radius: 12px;">
                            <strong>Warranty Status:</strong> <?php echo \App\Helpers\StringHelper::sanitizeHtml($product->warranty_countdown); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xammp\htdocs\bug-fixes v3\product_inventory\resources\views\products\edit.blade.php ENDPATH**/ ?>