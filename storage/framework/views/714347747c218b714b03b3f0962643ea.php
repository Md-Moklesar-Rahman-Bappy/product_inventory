  ...
  <div class="container py-3">
    <div class="text-center small text-muted fw-semibold" style="animation: fadeIn 0.6s ease-in-out;">
      <span>
        ...
        <span class="text-dark"><?php echo e(\App\Models\Setting::get('footer_credit', 'DLRS SOCDS Project')); ?></span>
      </span>
    </div>
  </div>
</footer>
...
<?php /**PATH D:\Xammp\htdocs\bug-fixes v3\product_inventory\resources\views\layouts\footer.blade.php ENDPATH**/ ?>