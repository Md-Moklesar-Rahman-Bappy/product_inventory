        ...
        <div class="install-card">
            ...
            <div class="install-body">
                <div class="steps-indicator">
                    ...
                    <?php for($i = 1; $i <= 5; $i++): ?>
                        <div class="step-dot <?php echo e($i < $currentStep ? 'completed' : ($i === $currentStep ? 'active' : '')); ?>"></div>
                    <?php endfor; ?>
                </div>
            ...
            <div class="install-footer">
                &copy; <?php echo e(date('Y')); ?> Product Inventory. Installation Wizard.
            </div>
        </div>
    </div>
...
<?php /**PATH D:\Xammp\htdocs\bug-fixes v3\product_inventory\resources\views\install\layout.blade.php ENDPATH**/ ?>