<?php $__env->startSection('title', 'Products in ' . $category->category_name); ?>
            ...
            <div class="table-header-section">
                <div class="row gy-3 align-items-center">
                    <div class="col-12 col-lg-2 d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="mb-0 fw-bold text-white">Products in <?php echo e($category->category_name); ?></h5>
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        <form id="searchForm" method="GET" action="<?php echo e(route('categories.products', $category->id)); ?>" class="d-none">
                    ...
                    <div class="col-12 col-lg-3 text-lg-end">
                        <?php if(auth()->user()->permission <= 1): ?>
                            <div class="d-flex flex-wrap justify-content-lg-end gap-2">
                                <a href="<?php echo e(route('categories.index')); ?>" class="btn btn-sm btn-light">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="<?php echo e(route('category.products.export', $category->id)); ?>">Export</a></li>
                                    </ul>
                                </div>
                                <a href="<?php echo e(route('products.create', ['category_id' => $category->id])); ?>" class="btn btn-sm btn-success">
                        ...
                        <tr>
                            <td colspan="8" class="text-center">
                                <div class="empty-state">
                                    ...
                                    <?php if(auth()->user()->permission <= 1): ?>
                                        <a href="<?php echo e(route('products.create', ['category_id' => $category->id])); ?>" class="btn btn-primary btn-sm">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xammp\htdocs\bug-fixes v3\product_inventory\resources\views\categories\products.blade.php ENDPATH**/ ?>