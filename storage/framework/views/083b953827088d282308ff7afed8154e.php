                ...
                <table class="table table-hover align-middle mb-0">
                    <thead class="table-header-gradient">
                        <tr>
                            ...
                            <th class="d-none d-md-table-cell" style="width: 60px;">Photo</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <small class="d-lg-none text-muted d-block"><?php echo e($user->designation ?? ''); ?></small>
                                <small class="d-md-none text-muted d-block"><?php echo e($user->email); ?></small>
                            </td>
                            <td class="d-none d-lg-table-cell"><?php echo e($user->designation ?? '—'); ?></td>
                            <td class="d-none d-md-table-cell"><span class="text-muted"><?php echo e($user->email); ?></span></td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\product_inventory_main\product_inventory\resources\views/users/index.blade.php ENDPATH**/ ?>