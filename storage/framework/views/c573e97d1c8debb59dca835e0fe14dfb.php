        ...
        <div class="profile-upload-card">
            <div class="profile-header">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <a href="<?php echo e(route('users.index')); ?>" class="btn btn-sm btn-outline-light">
            ...
            <div class="card-body p-4">
                <div class="row">
                    <div class="col-md-4 text-center">
                        <div class="profile-section mb-4">
                            ...
                            <div class="mt-3">
                                <span class="role-badge role-<?php echo e($user->role_label === 'Super Admin' ? 'superadmin' : ($user->role_label === 'Admin' ? 'admin' : 'user')); ?>">
                                    <?php echo e($user->role_label); ?>

                                </span>
                                <span class="status-badge <?php echo e($user->status === 'active' ? 'status-active' : 'status-inactive'); ?>">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="detail-card">
                                        ...
                                        <span class="detail-value"><?php echo e($user->designation ?? '—'); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <div class="detail-card">
                                        ...
                                        <span class="detail-value"><?php echo e($user->about ?? '—'); ?></span>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="detail-card">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="detail-card">
                                        ...
                                        <span class="detail-value">#<?php echo e($user->id); ?></span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="detail-card">
                                ...
                                <div class="col-md-6">
                                    <div class="detail-card">
                                        ...
                                        <span class="detail-value"><?php echo e($user->created_at->format('d M Y, h:i A')); ?></span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="detail-card">
                                        <span class="detail-label">Last Updated</span>
                                        <span class="detail-value"><?php echo e($user->updated_at->format('d M Y, h:i A')); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="d-flex justify-content-end gap-3 pt-3 border-top">
                    ...
                    <?php if(auth()->id() === $user->id || auth()->user()->permission <= 1): ?>
                        <a href="<?php echo e(route('users.edit', $user->id)); ?>" class="btn btn-edit px-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Xammp\htdocs\bug-fixes v3\product_inventory\resources\views\users\show.blade.php ENDPATH**/ ?>